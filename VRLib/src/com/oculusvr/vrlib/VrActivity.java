...
public class VrActivity extends ActivityGroup implements SurfaceHolder.Callback {
	...
	//SurfaceHolder.Callbacks接口，目前surfaceChanged以及surfaceDestroyed会通知
	//native层
	@Override
	...
	//使用AudioService进行音量调整，direction传入的是调整方向。
	...
	//处理按键响应，其中响应了音量调节。截获个按键信息交由native层响应
...
//	public boolean onTouchEvent( MotionEvent e ) {
	...
	//Pause时将注册在Application的Activity注销
	@Override
	...
	//Resume时将Activity注册至Application
	@Override
