...
public class VrLib implements android.view.Choreographer.FrameCallback,
	...
	public static android.app.IVRManager GetVRService( final Activity activity )
	{
		return null;
		//return (android.app.IVRManager)activity.getSystemService(android.app.IVRManager.VR_MANAGER);
	}
	...
	public static int setSchedFifoStatic( final Activity activity, int tid, int rtPriority ) {
		...
		android.app.IVRManager vr = GetVRService(activity);
		if ( vr == null ) {
	...
	public static int getPowerLevelState( Activity act ) {
		...
		android.app.IVRManager vr = GetVRService(act);
		if ( vr == null ) {
			Log.d(TAG, "VRManager was not found" );
			return level;
		}
