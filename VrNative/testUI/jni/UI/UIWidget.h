...
public:
	...
	void								SetImage( const int surfaceIndex, const OVR::eSurfaceTextureType textureType, char const * imageName );
	void								SetImage( const int surfaceIndex, const OVR::eSurfaceTextureType textureType, const GLuint image, const int width, const int height );
	void								SetImage( const int surfaceIndex, const OVR::eSurfaceTextureType textureType, const UITexture &image );
	void								SetImage( const int surfaceIndex, const OVR::eSurfaceTextureType textureType, const UITexture &image, const float dimsX, const float dimsY );
	void								SetImage( const int surfaceIndex, const OVR::eSurfaceTextureType textureType, const UITexture &image, const float dimsX, const float dimsY, const Vector4f &border );
